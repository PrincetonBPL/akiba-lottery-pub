** Title: akiba_subjects.do
** Author: Justin Abraham, Arun Varghese
** Desc: Combines lab data, respondent database, and questionnaires. Adapted from Arun's scripts.
** Input: pls_subject.csv, _C02akibasmart_anon, AKIBA SMART STUDY (Responses) - Form responses 1_anon.csv
...
use "$data_dir/lab/_C02akibasmart_anon.dta", clear
...
* Correcting error made with surveyid
...
* 2 identical entries for Kennedy (274505), dropping one
* 2 different entries for Dorcus (233962), NOTE: seems like he was given endline twice and gave different answers, keeping only the first entry
