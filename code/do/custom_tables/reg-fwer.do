...
foreach yvar in $regvars {
	...
	forval i = 1/3 {
		...
		sigstar, p(`p_adj') prec(2) pbracket pstar aer
...
loc footnote "\emph{Notes:} Columns 1--3 report OLS estimates of the treatment effect. Standard errors are in parentheses and FWER adjusted \(p\)-values are in brackets. Observations are at the individual level."
