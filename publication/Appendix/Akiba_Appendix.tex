...
\section{Summary statistics}
	...
	\subsection{Endline variables}
		...
		\begin{landscape} \input{../../tables/sum-ysum6.tex} \end{landscape}
		\begin{landscape} \input{../../tables/sum-ysum7.tex} \end{landscape}
		\begin{landscape} \input{../../tables/sum-ysum8.tex} \end{landscape}
		\begin{landscape} \input{../../tables/sum-ysum9.tex} \end{landscape}
...
\section{Treatment effects}
	...
	\subsection{Main effects}
		...
		\begin{landscape} \input{../../tables/reg-mobile.tex} \end{landscape}
		\begin{landscape} \input{../../tables/reg-panel.tex} \end{landscape}
		\begin{landscape} \input{../../tables/reg-save.tex} \end{landscape}
		\begin{landscape} \input{../../tables/reg-gamble.tex} \end{landscape}
		\begin{landscape} \input{../../tables/reg-akiba.tex} \end{landscape}
		\begin{landscape} \input{../../tables/reg-lottery.tex} \end{landscape}
		\begin{landscape} \input{../../tables/reg-self.tex} \end{landscape}
		\begin{landscape} \input{../../tables/reg-select.tex} \end{landscape}
	...
	\subsection{Heterogeneous effects}
		...
		\begin{landscape} \input{../../tables/het-demo_children_0.tex} \end{landscape}
		\begin{landscape} \input{../../tables/het-demo_married_0.tex} \end{landscape}
		\begin{landscape} \input{../../tables/het-demo_female_0.tex} \end{landscape}
		\begin{landscape} \input{../../tables/het-demo_young_0.tex} \end{landscape}
		\begin{landscape} \input{../../tables/het-demo_stdschool_0.tex} \end{landscape}
		\begin{landscape} \input{../../tables/het-demo_formschool_0.tex} \end{landscape}
		\begin{landscape} \input{../../tables/het-gam_mediancpgi_z_0.tex} \end{landscape}
		\begin{landscape} \input{../../tables/het-gam_medianindex_0.tex} \end{landscape}
		\begin{landscape} \input{../../tables/het-labor_dependants_0.tex} \end{landscape}
		\begin{landscape} \input{../../tables/het-labor_employed_0.tex} \end{landscape}
		\begin{landscape} \input{../../tables/het-labor_isdependant_0.tex} \end{landscape}
		\begin{landscape} \input{../../tables/het-labor_regularinc_0.tex} \end{landscape}
		\begin{landscape} \input{../../tables/het-labor_selfemployed_0.tex} \end{landscape}
		\begin{landscape} \input{../../tables/het-lnlabor_medianinc_0.tex} \end{landscape}
		\begin{landscape} \input{../../tables/het-lnsave_mediansave_0.tex} \end{landscape}
		\begin{landscape} \input{../../tables/het-pref_riskaverse_0.tex} \end{landscape}
		\begin{landscape} \input{../../tables/het-save_dosave_0.tex} \end{landscape}
		\begin{landscape} \input{../../tables/het-pref_medianloc_0.tex} \end{landscape}
		\begin{landscape} \input{../../tables/het-pref_medianindiff_0.tex} \end{landscape}
...
\section{Visualization}
	...
	\subsection{Panel treatment effects}
		...
		\centerfloat
		\includegraphics{../../figures/line-dl.pdf}
		\end{figure}
