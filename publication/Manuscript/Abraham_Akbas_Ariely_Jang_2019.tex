...
\section{Introduction}
	...
	% regret aversion mechanism reconciling past results is a discussion point not a contribution
	...
	% revisit this graf essentially talks about the policy promise of PLS, perhaps combine with above
	...
	% first say that there were two types of PLS
	...
	% first introduce the regret-control effect; maybe frame regret as being the default product and lottery as the extension
	% either talk about the regret-lottery effect then think about mechanisms or try to reconcile other lottery effects with this using the regret mechanisms
