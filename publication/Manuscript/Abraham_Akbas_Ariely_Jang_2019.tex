...
\section{Introduction}
	...
	% add somville paper on default effect
	% update simone reference to recent aej applied
	...
	% Consider putting back theoretical explanations here
	% Separate theory gap for regret aversion (what these past things haven't looked at is the regret confound)
	% might be able to do cross-cutting intro
	% If AEJ:Applied, gotta always frame it with development policy
	...
	% maybe after the results we can wax about theoretical explanations for findings
	% beef this graf with details and brief priors and what we expect
	% change presentation of results: first examine treatment arms together and then discuss separately as a way of teasing apart the effect of regret aversion
...
\section{Experimental Design} \label{sec:design}
	...
	\subsection{Context and Sampling}
		...
		% why is low income sample important? because it avoids weirdness with low stakes risk aversion and for external validity
...
\section{Results} \label{sec:results}
	...
	\subsection{PLS with Feedback Increases Deposit Frequency}
		...
		\input{../../tables/reg-fourmobile.tex}
		...
		% do these other schemes provide lottery results even without saving? (thus activating regret aversion)
		...
		% \input{../../tables/reg-fourselect.tex}
		% \input{../../tables/reg-fourself.tex}
	...
	\subsection{Regret Aversion is a Potential Mechanism}
		...
		% this isn't really an implication of regret aversion, which is a static model
		% the effects of this can only be understood from a dynamic perspective and even then it is ambiguous---anticipatory learning or some kind of salience
	...
	\subsection{PLS with Feedback Increases Gambling}
		...
		\input{../../tables/reg-fourgamble.tex}
