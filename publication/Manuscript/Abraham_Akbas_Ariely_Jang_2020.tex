...
\section{Results} \label{sec:results}
	...
	\subsection{PLS Increases Deposit Frequency}
		...
		% Dizon does not give feedback, Filiz-Ozbay does not, Brune no, Atalay no, Nyqvist no, Loibl no, 
		% Then talk about how feedback manipulation is typically used as a test for regret aversion
		% Dizon and Atalay: it is the availability of PLS rather than expected return that accounts for effects
