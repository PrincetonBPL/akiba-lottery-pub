...
\section{Modelling the Decision to Save with Regret Aversion}
	...
	When a subject in the PLS treatment makes a deposit her payoff $y$ is contingent on the outcome of the lottery $\ell = (p_1, p_2, p_3, p_4)$.
	...
	anticipated regret works to increase the number of PLS deposits when feedback about lottery results is always provided compared to when 

	% everything saved is subject to a discount factor
