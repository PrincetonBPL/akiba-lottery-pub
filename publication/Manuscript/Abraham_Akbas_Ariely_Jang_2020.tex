...
\section{Introduction}
	...
	Some have argued that the poor may be especially responsive to lottery-like incentives from the observation that the share of lottery expenditures is highest among low-income households \parencite{kearney_making_2010}. Whether PLS substitutes or complements gambling consumption is relevant in understanding the total welfare implications of this type of policy. To answer this question, we estimate effects of PLS on overall gambling by our participants and find that those in the PLS treatment reported higher gambling activity 15 percentage points more than the control group. We do not observe heterogeneous effects on any outcomes by preferences for risk or by an index of problem gambling.

	% Is this where we should discuss possible explanations for PLS demand? Can serve to motivate our second contribution.
	...
	% A critical distinction between our study and these earlier field experiments is that they estimate the effect of introducing a PLS product into individuals' choice sets and not the effect of the stochastic incentive per se. 
...
\section{Experimental Design} \label{sec:design}
	...
	\subsection{Sampling Frame}
		...
		% What do people save for? how long does this take? could affect what we see in this setting
		% Herzkowitz is a better reference for gambling in East Africa
...
\section{Empirical Strategy} \label{sec:est}
	...
	% \subsection{Average Treatment Effect}
		...
		% consider adding panel regression, multinomial logit, het effects if we talk about it 
		% should we report them even if null results because of lack of power?
...
\section{Results} \label{sec:results}
	...
	\subsection{The Role of Regret Aversion}
		...
		% Should we discuss different mechanisms here?
