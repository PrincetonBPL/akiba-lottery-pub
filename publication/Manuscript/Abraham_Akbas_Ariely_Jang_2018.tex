...
\section{Results} \label{sec:results}
	...
	\subsection{PLS with feedback increases number of deposits without increasing savings}
		...
		% it's all due to regret aversion, most deposits happen right after the lottery is announced
		...
		% what if this is just an endowment effect of holding the lottery ticket?
		% look at timing to see if transactions are after getting yesterdays results or after getting todays ticket
