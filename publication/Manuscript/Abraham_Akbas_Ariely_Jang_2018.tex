...
\section{Empirical Strategy} \label{sec:est}
	...
	\subsection{Testing for Regret Aversion}
		...
		\begin{equation} \begin{split}
		Y_{i,t} = & \pi_{1}\text{\textsc{Regret}}_{i} + \pi_{2}(\text{\textsc{Regret}}_{i} \times \text{Win}_{i,t}) + \omega_{t} + u_{i,t}
...
\section{Results} \label{sec:results}
	...
	\subsection{Effect on Deposits Persists Over Time}
		...
		\caption*{\footnotesize \emph{Notes:} Panel A plots the treatment effect of \textsc{Lottery} on number of deposits as a function of savings period. Panel B plots the treatment effect of \textsc{Regret} on number of deposits as a function of savings period. Shaded areas represent period-specific 95\% confidence regions.}
		\end{figure}
