...
\section{Treatment Effects}
    ...
    \subsection{Regressions at the participant-period level}
    ...
    \subsection{Logistic regression}
        ...
        \input{../../tables/reg-ologit.tex}
        \input{../../tables/reg-mlogselect.tex}

    \clearpage

\section{Baseline Correlates of Savings}
...
\section{Data Visualization}
	...
	\subsection{Panel treatment effects}
        ...
        \begin{figure}[ht]
        \centering
        \caption{Treatment effects over time -- Number of deposits}
        \includegraphics[width=\textwidth]{../../figures/line-timemobile_deposits.pdf}
        \end{figure}

        \begin{figure}[ht]
        \centering
        \caption{Treatment effects over time -- Amount deposited}
        \includegraphics[width=\textwidth]{../../figures/line-timemobile_depositamount.pdf}
        \end{figure}

        \begin{figure}[ht]
        \centering
        \caption{Autoregression of daily savings by treatment group -- Number of deposits}
        \includegraphics[width=\textwidth]{../../figures/lags-mobile_deposits.pdf}
        \end{figure}

        \begin{figure}[ht]
        \centering
        \caption{Autoregression of daily savings by treatment group -- Amount deposited}
