...
\section{Introduction}
	...
	How might lotteries induce savings? Preferences for skewed returns to choices under uncertainty are well-documented. The overweighting of small probabilities  \shortcite{kahneman_advances_1992} and, more recently, attention to salient payoffs \shortcite{bordalo_salience_2012} attempts to explain seemingly risk-loving behavior among risk-averse individuals.  \shortcite{hertwig_description–experience_2009}
