...
\section{Empirical Strategy\protect\footnote{We registered a pre-analysis plan documenting the experimental design, identification strategy, and outcomes of interest \shortcite{abraham_using_2015}. Project materials, including scripts and de-identified participant data, are available at \url{https://github.com/princetonbpl/akiba-lottery-pub}.}} \label{sec:est}
