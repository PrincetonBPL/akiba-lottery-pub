...
\section{Empirical Strategy\protect\footnote{We registered a pre-analysis plan documenting the experimental design, identification strategy, and outcomes of interest \shortcite{abraham_using_2015}. Files for replication are available at \url{https://github.com/princetonbpl/akiba-lottery-pub}.}} \label{sec:est}
...
\section{Results} \label{sec:results}
	...
	\subsection{Experiences of winning increases usage}
...
%
% 	What if these are just the effect of reminders?
