...
\section{Empirical Strategy} \label{sec:est}
	...
	\subsection{Testing the effect of experience on saving}
		...
		% effect may or may not vary over time. does effect depend on experience of winning (hot hand, gamblers) or regret?

\section{Results} \label{sec:results}

	% perhaps discuss baseline balance and attrition and empirical lottery results under this section

	\subsection{PLS + Regret increase number of deposits without increasing savings}
	...
	\subsection{PLS + Regret encourage uptake of informal saving}
	...
	\subsection{PLS + Regret increase outside gambling behavior}
...
% Overview of results:
%
% 	Regret increases number of deposits (days and more per day in extensive margin) (FWER at 10%)
% 	Lottery shows some evidence but perhaps underpowered
% 	No effect on balance
% 	Regret increases amount withdrew: they finance lottery plays
% 	Regret increases savings and usage of ROSCA: ????
% 	Regret increases self-reported gambling: could be internal or external but can't distringuish
% 	Lottery/Regret increases lucky person: hot hands, actually might make subjective bias worse
% 	Lottery/Regret increases self-selection into regret group: evidence of consumer demand from behavior _and_ self-report
%   Overall people think they will save less with regret treatment
...
%   The effect occurs right after the lottery results are announced.
