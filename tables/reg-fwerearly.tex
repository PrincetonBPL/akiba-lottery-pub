\begin{table}[h]\centering \def\sym#1{\ifmmode^{#1}\else\(^{#1}\)\fi} \caption{Treatment effects controlling the FWER -- Mobile savings by respondent (before 30 days)} \label{tab:reg-fwerearly} \maxsizebox*{\textwidth}{\textheight}{ \begin{threeparttable} \begin{tabular}{l*{8}{c}} \toprule
...
\midrule
Total no. of deposits (before 30 days)&2.56$^{*}$&3.08$^{**}$&     0.74&2.46$^{*}$&2.56$^{*}$&     0.95&     8.48&      311\\
          &   (1.40)&   (1.35)&         &   (1.43)&   (1.34)&         &   (8.74)&         \\
          &   [0.15]&[0.05]$^{*}$&         &   [0.19]&   [0.13]&         &         &         \\
No. of days saved (before 30 days)&1.94$^{*}$&2.56$^{**}$&     0.62&     1.67&2.18$^{*}$&     0.68&     7.42&      311\\
          &   (1.16)&   (1.15)&         &   (1.15)&   (1.15)&         &   (7.61)&         \\
          &   [0.18]&[0.06]$^{*}$&         &   [0.28]&   [0.13]&         &         &         \\
Daily avg. no. of deposits (before 30 days)&0.09$^{*}$&0.10$^{**}$&     0.74&0.08$^{*}$&0.09$^{*}$&     0.95&     0.28&      311\\
          &   (0.05)&   (0.05)&         &   (0.05)&   (0.04)&         &   (0.29)&         \\
          &   [0.15]&[0.05]$^{*}$&         &   [0.19]&   [0.13]&         &         &         \\
Total deposit amount (before 30 days)&    -1.17&    -1.65&     0.74&    -1.02&    -1.52&     0.71&     8.99&      311\\
...
% File produced by reg-fwer.do with /n/homeserver2/user2a/justinra/repos/akiba-lottery-pub/data/clean/akiba_wide.dta on 03:42:48 15 Feb 2018 by user justinra on Stata 13.1 with seed X71d1d353b37e281e006fa26738e26f4500044a1c