\begin{table}[h]\centering \def\sym#1{\ifmmode^{#1}\else\(^{#1}\)\fi} \caption{Treatment effects with randomization inference -- Savings outside the study} \label{tab:ri-save} \maxsizebox*{\textwidth}{\textheight}{ \begin{threeparttable} \begin{tabular}{l*{8}{c}} \toprule
...
% File produced by reg-ri.do with /n/homeserver2/user2a/justinra/repos/akiba-lottery-pub/data/clean/akiba_wide.dta on 05:13:47 16 Dec 2017 by user justinra on Stata 13.1 with seed Xb6b3b313878f2a163888d4c34dce75fa00043510