\begin{table}[htbp]\centering \def\sym#1{\ifmmode^{#1}\else\(^{#1}\)\fi} \caption{Treatment effects with randomization inference -- Savings outside the study} \label{tab:ri-save} \maxsizebox*{\textwidth}{\textheight}{ \begin{threeparttable} \begin{tabular}{l*{8}{c}} \toprule
...
\midrule
Total savings last mo.&    18.45&   -17.87&0.09$^{*}$&    16.75&   -12.44&     0.20&    80.31&      284\\
          &  (25.24)&  (14.70)&         &  (24.30)&  (15.53)&         & (112.74)&         \\
          &         &         &         &         &         &         &         &         \\
M-Pesa savings last mo.&    -5.42&    -6.71&     0.83&    -5.47&    -6.19&     0.90&    20.42&      284\\
          &   (6.36)&   (5.51)&         &   (6.33)&   (5.63)&         &  (44.67)&         \\
          &         &         &         &         &         &         &         &         \\
ROSCA savings last mo.&     1.48&     7.37&     0.40&     2.84&     7.85&     0.50&    22.24&      283\\
...
% File produced by reg-ri.do with /n/homeserver2/user2a/justinra/repos/akiba-lottery-pub/data/clean/akiba_wide.dta on 21:40:36 14 Apr 2017 by user justinra on Stata 13.1 with seed X8111b513415c774e53a74bf97992bbb60004184d