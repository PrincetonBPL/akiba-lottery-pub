\begin{table}[h]\centering \def\sym#1{\ifmmode^{#1}\else\(^{#1}\)\fi} \caption{Treatment effects with randomization inference -- Savings with other products} \label{tab:ri-save} \maxsizebox*{\textwidth}{\textheight}{ \begin{threeparttable} \begin{tabular}{l*{5}{c}} \toprule
...
\midrule
Total savings last month (USD PPP)&    18.45&   -17.87&0.10$^{*}$&    80.31&      284\\
          &  (25.24)&  (14.70)&         & (112.74)&         \\
          &         &         &         &         &         \\
M-Pesa savings last month (USD PPP)&    -5.42&    -6.71&     0.83&    20.42&      284\\
          &   (6.36)&   (5.51)&         &  (44.67)&         \\
          &         &         &         &         &         \\
ROSCA savings last month (USD PPP)&     1.48&     7.37&     0.41&    22.24&      283\\
          &   (6.78)&   (6.82)&         &  (42.18)&         \\
          &         &         &         &         &         \\
Currently saves with ROSCA&    -0.02&0.14$^{**}$&0.03$^{**}$&     0.54&      284\\
          &   (0.07)&   (0.07)&         &   (0.50)&         \\
          &         &         &         &         &         \\
...
% File produced by reg-ri.do with /n/homeserver2/user2a/justinra/repos/akiba-lottery-pub/data/clean/akiba_wide.dta on 04:13:04 16 Feb 2018 by user justinra on Stata 13.1 with seed Xf813d3137b26eb28f12bfdc81f53565f00044be3