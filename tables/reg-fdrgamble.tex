\begin{table}[h]\centering \def\sym#1{\ifmmode^{#1}\else\(^{#1}\)\fi} \caption{Treatment effects controlling the FDR -- Gambling} \label{tab:reg-fdrgamble} \maxsizebox*{\textwidth}{\textheight}{ \begin{threeparttable} \begin{tabular}{l*{5}{c}} \toprule
...
% File produced by reg-fdr.do with /Users/justin/Repos/akiba-lottery-pub/data/clean/akiba_wide.dta on 17:23:02 12 Aug 2020 by user justin on Stata 13.1 with seed X71d1d353b37e281e006fa26738e26f4500044a1c