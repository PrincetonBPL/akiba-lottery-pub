\begin{table}[htbp]\centering \def\sym#1{\ifmmode^{#1}\else\(^{#1}\)\fi} \caption{Heterogeneous effects - Primary outcomes by has dependant} \label{tab:het-labor_hasdependant_0} \maxsizebox*{\textwidth}{\textheight}{ \begin{threeparttable} \begin{tabular}{l*{5}{c}} \toprule
...
Constant        &    11.20\sym{***}&     0.19\sym{***}&     9.45\sym{***}&     0.13         &    -0.00         \\
                &   (2.66)         &   (0.04)         &   (2.18)         &   (0.08)         &      (.)         \\
\midrule
