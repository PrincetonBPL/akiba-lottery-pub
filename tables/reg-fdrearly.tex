\begin{table}[h]\centering \def\sym#1{\ifmmode^{#1}\else\(^{#1}\)\fi} \caption{Treatment effects controlling the FDR -- Mobile savings by respondent ($\leq$ 30 days)} \label{tab:reg-fdrearly} \maxsizebox*{\textwidth}{\textheight}{ \begin{threeparttable} \begin{tabular}{l*{8}{c}} \toprule
...
Daily avg. no. of deposits ($\leq$ 30 days)&0.09$^{*}$&0.10$^{**}$&     0.02&0.08$^{*}$&0.09$^{*}$&     0.00&     0.28&      311\\
          ...
          &   [0.15]&[0.04]$^{**}$&   [1.00]&   [0.21]&[0.09]$^{*}$&   [1.00]&         &         \\
Total deposit amount ($\leq$ 30 days)&    -1.17&    -1.65&    -0.48&    -1.02&    -1.52&    -0.50&     8.99&      311\\
          &   (2.07)&   (1.85)&   (1.46)&   (1.84)&   (1.69)&   (1.36)&  (17.18)&         \\
          &   [0.17]&   [0.11]&   [1.00]&   [0.24]&   [0.11]&   [1.00]&         &         \\
...
% File produced by reg-fwer.do with /Users/Justin/Repos/akiba-lottery-pub/data/clean/akiba_wide.dta on 13:35:18  4 Feb 2018 by user Justin on Stata 13.1 with seed X02be4b816237fe6e6a333726618fd6dd00043d82