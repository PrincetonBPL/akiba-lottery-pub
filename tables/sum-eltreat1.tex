\begin{table}[htbp]\centering \def\sym#1{\ifmmode^{#1}\else\(^{#1}\)\fi} \caption{Baseline balance check by treatment group for endline sample} \label{tab:sum-eltreat1} \maxsizebox*{\textwidth}{\textheight}{ \begin{threeparttable} \begin{tabular}{l*{5}{c}} \toprule
...
% File produced by sum-eltreat.do with /Users/Justin/Repos/akiba-lottery-pub/data/clean/akiba_wide.dta on 15:12:40 18 May 2017 by user Justin on Stata 13.1 with seed X53d8cd0fc43f462544a474abacbdd93d00044a8f