...
\begin{frame}{Related Literature}
	...
	\begin{itemize}
		...
		% Except for Consequences of Regret Aversion 2: Additional Evidence for Effects of Feedback on Decision Making
...
% 		\item Regret can be averted in PLS without feedback by not saving/entering the lottery.
% 		\item Safe outcome is less attractive in feedback group because 1) can experience regret from missing out on big prize and 2) can't use the safe option to avert regret.
% 		\item Neither choice is regret averting in PLS with feedback.
% 		\item Differences between the two lottery conditions can be attributed to regret aversion.
% 	\end{wideitemize}

	% How do we show this in the model? Presence of the R term
	% does this imply that R is evaluated in this case to be negative?
